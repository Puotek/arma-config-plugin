 ...
 */
class CfgSmartEnterProcessor : SmartEnterProcessor() {

    override fun process(project: Project, editor: Editor, file: PsiFile): Boolean {
        val armaFile = file as? CfgFile ?: return false
        ...
        if (tokenType == CfgTypes.PREPROCESSOR || tokenType == CfgTypes.SINGLE_QUOTE) {
            return false
        }
