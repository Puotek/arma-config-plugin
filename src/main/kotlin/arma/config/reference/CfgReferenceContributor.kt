...
class CfgReferenceContributor : PsiReferenceContributor() {

    override fun registerReferenceProviders(registrar: PsiReferenceRegistrar) {
        registrar.registerReferenceProvider(
            PlatformPatterns.psiElement().withElementType(CfgTypes.PREPROCESSOR),
            object : PsiReferenceProvider() {
                override fun getReferencesByElement(
                    ...
                    return arrayOf(
                        CfgIncludeReference(element, rangeInElement)
                    )
                }
            }
        )
